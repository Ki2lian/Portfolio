...
const CarouselNext = ({ className, size = "icon", variant = "outline", ...props }: React.ComponentProps<typeof Button>) => {
...
const CarouselPrevious = ({ className, size = "icon", variant = "outline", ...props }: React.ComponentProps<typeof Button>) => {
