...
const NavigationMenu = ({
    ...
    <NavigationMenuPrimitive.Root
        className={ cn("group/navigation-menu relative flex flex-1 justify-center items-center max-w-max", className) }
...
const NavigationMenuList = ({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.List>) => (
    <NavigationMenuPrimitive.List
        className={ cn("group flex flex-1 justify-center items-center gap-1 list-none", className) }
...
const NavigationMenuTrigger = ({ children, className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Trigger>) => (
    <NavigationMenuPrimitive.Trigger className={ cn(navigationMenuTriggerStyle(), "group", className) } data-slot="navigation-menu-trigger" { ...props }>
        {children}{" "}
        <LuChevronDown aria-hidden="true" className="top-[1px] relative ml-1 size-3 group-data-[state=open]:rotate-180 transition duration-300" />
    </NavigationMenuPrimitive.Trigger>
);

const NavigationMenuViewport = ({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Viewport>) => (
    <div className={ cn("top-full left-0 z-50 isolate absolute flex justify-center") }>
