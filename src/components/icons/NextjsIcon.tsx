...
export const NextjsIcon = ({ size, bgColor, textColor, ...props }: ComponentPropsWithoutRef<'svg'> & IIconProps) => (
    <svg width={ size || 24 } height={ size || 24 } viewBox="0 0 256 256" version="1.1" preserveAspectRatio="xMidYMid" { ...props }>
        <defs>
            <circle id="path-1" cx="128" cy="128" r="128"></circle>
            <linearGradient x1="55.6325605%" y1="56.3850422%" x2="83.2279093%" y2="96.0801119%" id="nextjsLinearGradient-3">
                <stop stopColor={ textColor || '#FFFFFF' } offset="0%"></stop>
                <stop stopColor={ textColor || '#FFFFFF' } stopOpacity="0" offset="100%"></stop>
            </linearGradient>
        ...
        <g>
            ...
            <g mask="url(#mask-2)">
                <circle fill={ bgColor || '#000000' } cx="128" cy="128" r="128"></circle>
                <path
