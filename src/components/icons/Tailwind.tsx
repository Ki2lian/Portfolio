...
export const Tailwind = ({ bgColor, size, ...props }: ComponentPropsWithoutRef<"svg"> & IIconProps) => (
    <svg height={ size || 24 } preserveAspectRatio="xMidYMid" version="1.1" viewBox="0 0 256 154" width={ size || 24 } { ...props }>
        <defs>
