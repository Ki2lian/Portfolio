...
export const NodeJS = ({ size, ...props }: ComponentPropsWithoutRef<"svg"> & IIconProps) => (
    <svg height={ size || 24 } version="1.2" viewBox="0 0 442.37 270.929" width={ size || 24 } { ...props }>
        <defs>
            <clipPath id="a">
            ...
            <linearGradient gradientTransform="rotate(116.114 53.1 202.97) scale(86.48)" gradientUnits="userSpaceOnUse" id="b" x1="-.348" x2="1.251">
            ...
            <linearGradient gradientTransform="translate(192.862 279.652) scale(97.417)" gradientUnits="userSpaceOnUse" id="f" x1=".043" x2=".984">
        ...
        <g clipPath="url(#a)" transform="translate(-78.306 -164.016)">
            <path d="M331.363 246.793l-118.715-58.19-60.87 124.174L270.49 370.97zm0 0" fill="url(#b)" />
        </g>
        <g clipPath="url(#c)" transform="translate(-78.306 -164.016)">
            <path d="M144.07 264.004l83.825 113.453 110.86-81.906-83.83-113.45zm0 0" fill="url(#d)" />
        </g>
        <g clipPath="url(#e)" transform="translate(-78.306 -164.016)">
            <path d="M197.02 225.934v107.43h91.683v-107.43zm0 0" fill="url(#f)" />
        </g>
    </svg>
);
