...
export const TailwindIcon = ({ size, bgColor, ...props }: ComponentPropsWithoutRef<'svg'> & IIconProps) => (
    <svg width={ size || 24 } height={ size || 24 } viewBox="0 0 256 154" version="1.1" preserveAspectRatio="xMidYMid" { ...props }>
        <defs>
        ...
        <g>
            <path
                ...
                fill={ bgColor || 'url(#linearGradient-1)' }
            ></path>
        </g>
    </svg>
);